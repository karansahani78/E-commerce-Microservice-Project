...
public class OrderController {
    ...
    public OrderDTO fallbackPlaceOrder(OrderDTO orderDTO, RuntimeException exception) {
        // Create and return a fallback OrderDTO with a service-unavailable status
        OrderDTO fallbackOrder = new OrderDTO();
        fallbackOrder.setMessage("Order Service is not available. Please try again later.");
